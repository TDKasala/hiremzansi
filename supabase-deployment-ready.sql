-- Hire Mzansi Database Schema for Supabase Deployment
...
(
    ...
    'Join our dynamic team building innovative software solutions for the South African market.',
...
(
    ...
    'Drive marketing campaigns and brand awareness across South Africa.',
    ARRAY['Digital Marketing', 'Social Media', 'Analytics', 'Campaign Management'],
    'R18,000 - R30,000',
    'Full-time',
    'Marketing',
    'Entry-level',
...
(
    ...
    ARRAY['SQL', 'Python', 'Excel', 'Statistical Analysis'],
    'R22,000 - R35,000',
    'Full-time',
    'Finance',
    'Mid-level',
...
CREATE POLICY "Admins can manage CV analyses" ON cv_analyses
    FOR ALL USING (
        EXISTS (
            SELECT 1 FROM users 
            WHERE id = auth.uid() 
...
GRANT INSERT, UPDATE, DELETE ON users, cv_analyses, newsletter_subscriptions, referrals, user_rewards TO authenticated;
