...
const plans = [
  {
    ...
    features: [
      ...
      'Limited keyword recommendations',
      'B-BBEE and NQF detection',
    ],
    scanLimit: 3,
    popular: false,
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      'Deep analysis with GPT-4o (when available)',
      'South African context awareness',
      'Industry-specific recommendations',
      'B-BBEE and NQF optimization',
  ...
  },
  {
    ...
    features: [
      ...
      'Double the scan limit (100 scans/month)',
      'Priority processing',
