  ...
  const tools = [
    {
      ...
      icon: <Key className="h-8 w-8 text-amber-500 mb-2" />,
    ...
    },
    {
      ...
      icon: <PenTool className="h-8 w-8 text-amber-500 mb-2" />,
    ...
    },
    {
      ...
      icon: <CheckSquare className="h-8 w-8 text-amber-500 mb-2" />,
    ...
    },
    {
      ...
      icon: <FileType className="h-8 w-8 text-amber-500 mb-2" />,
    ...
    },
    {
      ...
      icon: <MessageSquare className="h-8 w-8 text-amber-500 mb-2" />,
    ...
    },
    {
      ...
      icon: <Award className="h-8 w-8 text-amber-500 mb-2" />,
    ...
    },
    {
      ...
      icon: <FileText className="h-8 w-8 text-amber-500 mb-2" />,
      link: '/skills/analyze',
