...
export function ConsentDialog({ isOpen, onClose, onConfirm, cvId, score }: ConsentDialogProps) {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>CV Analysis Complete</DialogTitle>
          <DialogDescription>
            Your CV has been successfully analyzed with a score of {score}%
          </DialogDescription>
        </DialogHeader>
