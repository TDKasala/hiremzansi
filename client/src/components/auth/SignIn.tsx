  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col min-h-screen">
        ...
        <div className="lg:hidden bg-gradient-to-r from-primary to-primary/90 px-6 pt-12 pb-8 text-white">
          <div className="text-center">
            <div className="inline-flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                <TrendingUp className="h-6 w-6 text-white" />
              </div>
              <span className="text-2xl font-bold">Hire Mzansi</span>
            </div>
            <h1 className="text-xl font-medium mb-2">Welcome back</h1>
            <p className="text-white/80 text-sm">Continue optimizing your career</p>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
          <div className="w-full max-w-md">
            ...
            {/* Form Card */}
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 lg:p-8 backdrop-blur-sm">
              {/* Error Alert */}
              {error && (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    disabled={loading}
                    required
                    className="h-12 border-gray-200 focus:border-primary focus:ring-primary/20 transition-all duration-200 text-base"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      disabled={loading}
                      required
                      className="h-12 pr-12 border-gray-200 focus:border-primary focus:ring-primary/20 transition-all duration-200 text-base"
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5 mt-6"
                  disabled={loading}
                >
                  {loading ? (
