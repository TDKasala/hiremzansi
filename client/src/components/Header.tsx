  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <Link href="/">
          <a className="text-secondary font-bold text-xl md:text-2xl flex items-center">
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-neutral-200">
            ...
            <div className="flex space-x-2 mt-3 px-3">
              <Link href="/login">
                <a className="flex-1 px-4 py-2 border border-primary text-primary text-center rounded-md hover:bg-primary hover:text-white transition-colors">
                  Log In
                </a>
              </Link>
              <Link href="/signup">
                <a className="flex-1 px-4 py-2 bg-primary text-white text-center rounded-md hover:bg-opacity-90 transition-colors">
                  Sign Up
                </a>
              </Link>
            </div>
