/**
 * South African ATS CV Analyzer
 * 
 * A local, client-side CV analyzer optimized for the South African job market
 * that works without requiring external API calls.
 */
...
const SA_KEYWORDS = [
  ...
  "uct", "ukzn", "up", "uj", "ufs", "zulu", "xhosa", "afrikaans", "sesotho", 
  "setswana", "sepedi", "venda", "tsonga", "swazi", "ndebele"
];

// Common skills to detect
const COMMON_SKILLS = [
  "javascript", "python", "java", "react", "angular", "node.js", "express",
  "html", "css", "sql", "nosql", "aws", "azure", "docker", "kubernetes", 
  "git", "agile", "scrum", "project management", "leadership", "communication", 
  "problem solving", "teamwork", "microsoft office", "excel", "powerpoint",
  "data analysis", "machine learning", "ai", "business intelligence", "tableau"
];

// South African certifications and professional bodies
...
/**
 * Calculate job match score between a CV and job description
 */
